...
Java_com_example_test_LEDevent_openDriver(JNIEnv *env, jclass clazz, jstring path) {
...
Java_com_example_test_LEDevent_closeDriver(JNIEnv *env, jclass clazz) {
// TODO: implement closeDriver()
if(fd<0) close(fd);
}

JNIEXPORT void JNICALL
Java_com_example_test_LEDevent_writeDriver(JNIEnv *env, jclass clazz, jbyteArray data,
jint length) {
